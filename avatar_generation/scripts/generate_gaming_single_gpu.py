...
def main():
    parser = argparse.ArgumentParser(description='游戏赛道单GPU生成')
    ...
    parser.add_argument('--output-dir', type=str, default='gaming_avatars_output', help='输出目录')
    ...
    print(f"[GPU {args.gpu}] 游戏赛道 - 开始初始化...")
    ...
    try:
        ...
        for i in range(args.num_images):
            ...
            try:
                ...
                # 保存图像
                output_path = output_dir / f"gaming_avatar_{global_idx:05d}.png"
